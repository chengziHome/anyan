...
const utils = {
    getHomeByUsername: getHomeByUsername,
    hasVideoStreamPhoneWS: hasVideoStreamPhoneWS,
    hasVideoStreamHomeWS: hasVideoStreamHomeWS,
    getPairByHome: getPairByHome,
    getPairByPhone: getPairByPhone,
    getPairByUUID: getPairByUUID,
